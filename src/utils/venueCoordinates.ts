...
/**
 * Resolves a match's venue to its stadium's map coordinates — by city (with a
 * small alias table for FIFA labels that differ from the curated stadium city),
 * then by stadium name. Returns null when the venue can't be located.
 */
