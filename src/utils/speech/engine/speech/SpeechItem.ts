...
// Export to window for browser compatibility (debug aid). Cast to keep agora's
// stricter DOM typings happy without changing upstream behaviour.
if (typeof window !== 'undefined') {
	(window as unknown as Record<string, unknown>).SpeechItem = SpeechItem;
}