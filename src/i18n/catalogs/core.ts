...
export const coreCatalog: CatalogModule = {
  pt: {
    ...
    "champion.title": "{name} — Campeã do Mundo 2026",
    "champion.subtitle": "Elenco campeão da Copa do Mundo FIFA 2026",
    "champion.tileAria": "Ver a seleção campeã — {name}",
  ...
  es: {
    ...
    "champion.title": "{name} — Campeón del Mundo 2026",
    "champion.subtitle": "Plantel campeón de la Copa Mundial FIFA 2026",
    "champion.tileAria": "Ver la selección campeona — {name}",
