...
| `GroupMatchHistory.tsx` | Collapsible `<details>` with a group's compact match history (finished + live results, chronological), rendered in each group card directly below "Análise do grupo" in StandingsView. Hidden until a match is played |
